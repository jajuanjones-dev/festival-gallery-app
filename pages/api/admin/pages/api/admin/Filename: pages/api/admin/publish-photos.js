...
// Each photo involves a Drive download, two image transforms, and two R2
// uploads - budget accordingly. Publish in batches of ~10-15 at a time
// rather than the whole event at once, or this can run into the function
// timeout on larger batches.
export const config = {
  maxDuration: 60,
};
